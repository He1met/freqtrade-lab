...
assert freeze['state']=='OPEN' and freeze['number']==64
...
p.SYMBOL='BCH/USDT:USDT';p.INSTRUMENT_ID='BCH-USDT-SWAP';p.PAIR_FAMILY='BCH-USDT';p.FUTURES_TIMEFRAME='1d'
p.PROFILE_ACQUISITION={'scope':'FUNDING_ONLY_PREFLIGHT','issue':64,'pair':p.SYMBOL,'timeframe':'1d'}
