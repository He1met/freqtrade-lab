...
assert c['class_name']==f'BchExactGridDualSmaR{n}'
reference=(r/'frozen-r1-reference.py').read_text()
if n==2: reference=reference.replace('BchExactGridDualSmaR1','BchExactGridDualSmaR2').replace('-0.20','-0.10')
