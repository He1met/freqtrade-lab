...
class EthTsmom28Sma84(IStrategy):
    INTERFACE_VERSION = 3
    timeframe = "1d"
    can_short = True
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        dataframe.loc[(dataframe["close"] > dataframe["close_28"]) & (dataframe["close"] > dataframe["entry_sma_84"]), "enter_long"] = 1
        dataframe.loc[(dataframe["close"] < dataframe["close_28"]) & (dataframe["close"] < dataframe["entry_sma_84"]), "enter_short"] = 1
        return dataframe
