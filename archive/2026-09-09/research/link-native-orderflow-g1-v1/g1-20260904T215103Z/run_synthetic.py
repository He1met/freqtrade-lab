"""Frozen G1 SYNTHETIC_TEST_ONLY native cases. No real dataset access or matching patches."""
import copy
import hashlib
import json
import sys
...
def execution_case():
    ...
    cfg = {'runmode': RunMode.BACKTEST, 'trading_mode': TradingMode.FUTURES, 'margin_mode': MarginMode.ISOLATED,
        ...
        'dataformat_ohlcv': 'feather', 'dataformat_trades': 'feather', 'export': 'none', 'backtest_cache': 'none',
