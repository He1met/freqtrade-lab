...
agg=r/'aggregated-retained-v2';agg.mkdir(mode=0o700);raw=agg/'raw';raw.mkdir(mode=0o700)
...
receipts=agg/'http-receipts.jsonl';receipts.write_bytes(b''.join(canonical(x) for x in allrows))
