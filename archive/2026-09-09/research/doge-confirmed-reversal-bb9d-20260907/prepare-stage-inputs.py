...
base=['--source-root',str(r/'complete-source'),'--source-provenance-sha256',h['provenance_sha256'],'--source-receipt-sha256',h['retrieval_receipt_sha256'],'--database',str(r/'lab.sqlite'),'--profile-id','issue98-doge-confirmed-reversal-v1','--search-timerange','20231106-20241104','--development-timerange','20241104-20251103','--pre-roll-candles','37','--economic-gate',str(r/'economic-gate.json'),'--single-baseline',str(r/'single-baseline.json')]
