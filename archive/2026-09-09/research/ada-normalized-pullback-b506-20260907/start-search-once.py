...
assert context['candidates'][0]['strategy_sha256']==sha((r/'AdaNormalizedTrendPullback3D.py').read_bytes())
...
payload={'profile_id':'issue101-ada-normalized-pullback-v1','candidate_ids':[context['candidates'][0]['candidate_id']]}
