...
assert sha(r/'final-protocol.md')=='66b18f5162e9020945562e31f1ad34a35305a8e1cac752d88aad084817ea8d57'
assert sha(r/'AdaNormalizedTrendPullback3D.py')=='eb1f551464519f52b6f29469843dfe0acc880b53a6e86b778b94f09a88eda4b8'
assert sha(r/'synthetic-equivalence.json')=='bbfe85d261f0661ab04dcc1bacbb8797afaa5fdc23fb8cd8f68e37f95eb54e0c'
validate_bounded_causal_strategy_file(r/'AdaNormalizedTrendPullback3D.py','AdaNormalizedTrendPullback3D',expected_timeframe='1d')
def write(name,obj):
...
write('supervisor-authorization.json',{'authorized_by_thread':'01a05dcc-17fd-7972-9177-9fed95e4b07a',
 ...
 'strategy_sha256':sha(r/'AdaNormalizedTrendPullback3D.py'),
 'synthetic_receipt_sha256':sha(r/'synthetic-equivalence.json'),
 'lab_commit':'3930287de83104ec93cad4f6a2c9b9248bf575e0',
 ...
 'capture_window':['2023-08-26','2025-11-03'],'pre_roll':72,'capture_maximum':1,
...
profile={'id':'issue101-ada-normalized-pullback-v1','name':'Issue98 ADA confirmed shock reversal 3D',
 'domain':'BINANCE_CRYPTO_PERP','exchange':'binance','trading_mode':'futures','margin_mode':'isolated',
 'pairs_json':'["ADA/USDT:USDT"]','timeframe':'1d','detail_timeframe':None,'history_start_date':'2023-08-26',
...
baseline={'mode':'SINGLE_BASELINE_V1','version':1,'maximum_attempts':1,'maximum_rounds':1,
 'protocol_sha256':sha(r/'final-protocol.md'),'strategy_sha256':sha(r/'AdaNormalizedTrendPullback3D.py')}
write('economic-gate.json',gate);write('single-baseline.json',baseline)
write('window.json',{'schema':'freqtrade-lab-profile-source-window-v1','data_start_utc':'2023-08-26T00:00:00Z',
 'search_start_utc':'2023-11-06T00:00:00Z','development_start_utc':'2024-11-04T00:00:00Z','end_exclusive_utc':'2025-11-03T00:00:00Z'})
write('profile-contract.json',profile_search_contract(snapshot,'20231106-20241104','20241104-20251103',72,gate,single_baseline=baseline))
