...
record=dict(record_type='COHORT_PREREGISTERED',cohort_id='issue101-ada-normalized-pullback-single-v1',issue=101,
 recorded_at_utc=datetime.now(timezone.utc).isoformat(),root=str(r),pair='ADA/USDT:USDT',instrument_id='ADAUSDT',pair_family='ADA-USDT',exchange='binance',
 ...
 pre_roll_candles=72,mode='SINGLE_BASELINE_V1',maximum_rounds=1,maximum_attempts=1,maximum_generations=1,maximum_captures=1,
 ...
 prior_exposure='FUNDING_QC_ONLY: ada-funding-qc-b506-20260907; no OHLCV or Search',external_unregistered_exposure='UNKNOWN',
...
files=['final-protocol.md','supervisor-authorization.json','profile-snapshot.json','profile-contract.json','AdaNormalizedTrendPullback3D.py','single-baseline.json','economic-gate.json','window.json','synthetic-equivalence.json','generation-approved.json']
...
with ledger.with_suffix(ledger.suffix+'.lock').open('a+b') as lock:
 ...
 assert len(before)==129434 and sha(before)=='175577aa8424b0c9b0d477e5b5925528b4e0864ad0ae587d2c23d9ca31323003'
