...
code = (r / 'AdaNormalizedTrendPullback3D.py').read_text()
...
payload = dict(profile_id='issue101-ada-normalized-pullback-v1', idea=idea,
               strategy_family='ada_normalized_trend_pullback_3d_v1',
