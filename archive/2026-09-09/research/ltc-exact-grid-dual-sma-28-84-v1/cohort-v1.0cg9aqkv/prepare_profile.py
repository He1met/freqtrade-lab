...
profile_id='ltc-exact-grid-dual-sma-28-84-v1'
profile={'id':profile_id,'name':'LTC_EXACT_GRID_DUAL_SMA_28_84_V1','domain':'OKX_CRYPTO_PERP','exchange':'okx','trading_mode':'futures','margin_mode':'isolated','pairs_json':json.dumps(['LTC/USDT:USDT']),'timeframe':'1d','detail_timeframe':None,'history_start_date':'2023-10-04','smoke_days':30,'holdout_days':180,'starting_balance':1000,'stake_amount':100,'max_open_trades':1,'taker_fee_rate':.0005,'stress_fee_multiplier':2,'max_drawdown_pct':15,'min_development_trades':5,'min_holdout_trades':4,'min_profit_factor':1.10,'is_default':1,'created_at':datetime.now(UTC).isoformat(),'updated_at':datetime.now(UTC).isoformat()}
